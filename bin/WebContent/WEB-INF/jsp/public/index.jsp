...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(<%=request.getContextPath() %>/templates/public/img/bg-img/16.jpg);" data-img-url="img/bg-img/16.jpg">
                <!-- Welcome Content -->
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(<%=request.getContextPath() %>/templates/public/img/bg-img/18.jpg);" data-img-url="img/bg-img/18.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                        ...
                        <div class="row no-gutters">
                            <div class="col-6">
                                <div class="single-thumb">
                                    <img src="<%=request.getContextPath() %>/templates/public/img/bg-img/13.jpg" alt="">
                                </div>
                                <div class="single-thumb">
    ...
    <section class="roberto-rooms-area">
        <div class="rooms-slides owl-carousel">
            ...
            <div class="single-room-slide d-flex align-items-center">
                <!-- Thumbnail -->
                <div class="room-thumbnail h-100 bg-img" style="background-image: url(<%=request.getContextPath() %>/templates/public/img/bg-img/17.jpg);"></div>
