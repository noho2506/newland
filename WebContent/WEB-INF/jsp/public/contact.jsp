<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="breadcrumb-area contact-breadcrumb bg-img bg-overlay jarallax" style="background-image: url(${defines.urlPublic}/img/quan-cafe-co-view-cao-da-nang.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
